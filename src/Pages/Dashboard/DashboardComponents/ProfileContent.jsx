  ...
  return (
    <div className="w-12/12 flex">
      <div className="w-4/12  ">
        <div className="m-2  p-2 py-5 rounded-md  bg-slate-800  ">
        ...
        <div
          ...
          className="grid-cols-4 m-2 rounded-md p-2 grid-rows-2 bg-slate-800 overflow-auto"
        >
      ...
      <div className="w-8/12 ">
        <div className="grid grid-cols-4 gap-2 rounded-md p-2 text-center">
          <div
            ...
            className="bg-primary-400 flex bg-slate-800 items-center justify-center flex-col rounded-md"
          >
          ...
          <div
            ...
            className="bg-primary-400 flex bg-slate-800 items-center justify-center p-10 flex-col rounded-md"
          >
