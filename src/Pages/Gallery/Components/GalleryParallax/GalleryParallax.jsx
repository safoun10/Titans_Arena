		...
		<div className="text-white">
			<div>
				...
				<div className="parallax mb-1 md:h-screen h-96 z-10 flex bg-[url('https://asphalt9.assets.gameloft.com/assets/bg_banner_desktop_v2_79125a46ce.jpg')]">
					<div className="my-auto items-center px-4">
						...
						<div className="w-96 gallery-subtitle">
							Race Through Urban Streets, Drift Around Corners,
							and Dominate the Asphalt in Heart-Pounding
							Excitement Unleash your inner speed demon in the
							world of Asphalt Adventures. Take control of
							high-performance cars, tackle challenging tracks,
							and compete against fierce opponents. Are you ready
							to rule the asphalt?
						</div>
					</div>
				</div>
				<div className="parallax mb-1 md:h-screen h-96 z-20 flex bg-[url('https://i.postimg.cc/NMGYNc8G/wallpaperflare-com-wallpaper-7.jpg')]">
					<div className="my-auto items-center mx-52 px-4">
						<div className="sub-title-gallery bg-gradient-to-b from-transparent to-[] text-2xl font-bold ">
							Call of Duty: Warfare Unleashed
						</div>
						<div className="w-96 gallery-subtitle">
							Immerse Yourself in the Intense World of Modern
							Warfare. Engage in Heart-Pounding Combat, Tactical
							Strategy, and Unforgettable Campaigns. Join the
							Global Battle for Supremacy and Prove Your Skills in
							the Most Iconic FPS Series of All Time.
						</div>
					</div>
				</div>
				...
				<div className="parallax mb-1 md:h-screen h-96 z-20 bg-[url('https://generationzero.com/content/1-home/pests-1.jpg')]">
					<div>
						...
						<div className="text-center text-[24px]">
							Read the latest news from the Tech Titans
							development team.
						</div>
