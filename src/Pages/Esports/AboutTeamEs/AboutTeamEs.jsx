    ...
    <div className=" bg-black bg-opacity-20 ">
      <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
        <div className="z-30 relative lg:w-1/2">
          <div className="hidden dark:bg-black bg-gray-100 w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
        ...
        <div className="bg-gray-100 dark:bg-black lg:w-1/2 lg:ml-12 lg:p-14 p-8 flex items-center">
          <div>
