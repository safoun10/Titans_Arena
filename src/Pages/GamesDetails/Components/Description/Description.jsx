...
const Description = ({ gameDetails }) => {
	...
	return (
		<div>
								...
								<tbody>
									...
									<tr>
										...
										<td className="py-2 px-4">
											{" "}
											{systemSupport &&
											systemSupport.crossPlatformPlay
												? "Yes"
												: "No"}
										</td>
									</tr>
			...
			<div className="flex max-w-7xl mx-auto py-10 rounded-md overflow-hidden shadow-md">
